var translations = {
    en: {
        ...
        "journey.law.description":
            "Practiced law leading regulatory work in oil & gas and infrastructure. That experience sharpened my analytical thinking, attention to detail, and ability to reason through complex constraints — skills I now apply to software engineering.",
        "journey.transition.date": "2024 — 2025 · The Shift",
        "journey.transition.title": "Deconstructing Logic",
        "journey.transition.description":
            "Transitioned full-time into software development. Focused on Java, OOP and modern web development while building full-stack projects and strengthening my cloud fundamentals. Worked at NTT Data, one of the largest IT consultancies in the world.",
        ...
        "skills.subtitle":
            "A curated stack built for performance and scalability.",
        "skills.backend": "Backend",
        "skills.backend.1": "Java / OOP / Spring Boot",
        "skills.backend.2": "Node.js / API basics",
        "skills.backend.3": "SQL (MySQL / SQL Server)",
        "skills.backend.4": "Integration (MuleSoft)",
        "skills.backend.5": "Swift / Kotlin (mobile basics)",
        "skills.frontend": "Frontend",
        "skills.frontend.1": "HTML / CSS / Responsive UI",
        "skills.frontend.2": "JavaScript / TypeScript",
        "skills.frontend.3": "React / Next.js",
        "skills.frontend.4": "Tailwind CSS",
        "skills.infra": "Infrastructure",
        "skills.infra.1": "Azure Fundamentals",
        "skills.infra.2": "Vercel deployments",
        "skills.infra.3": "Google Cloud",
        "skills.infra.4": "Serverless DB (Neon)",
        "skills.tools": "Tools",
        "skills.tools.1": "Git / GitHub",
        "skills.tools.2": "IntelliJ / VS Code",
        "skills.tools.3": "Postman / API testing",
        "skills.tools.4": "Agile (Azure DevOps / Jira)",
        ...
        "certs.az900.name": "Microsoft",
        "certs.az900.desc": "Azure Fundamentals (AZ-900)",
        ...
        // Contact
        "contact.title.line1": "Initiate",
        "contact.title.highlight": "Transmission",
        "contact.description":
            "Whether you're looking to build a modern web application or need a technical partner with strong analytical background, feel free to reach out.",
        "contact.email.label": "Email",
        "contact.location.label": "Current Orbit",
        "contact.location.value": "Portugal",
        "contact.form.name.label": "Sender Identity",
        "contact.form.name.placeholder": "Your name",
        "contact.form.email.label": "Return Path",
        "contact.form.email.placeholder": "email@example.com",
        "contact.form.message.label": "Message Payload",
        "contact.form.message.placeholder": "Briefly describe your project...",
        "contact.form.submit": "Execute Transmission",
    ...
    pt: {
        ...
        "journey.law.description":
            "Atuei como advogado liderando trabalhos regulatórios em óleo & gás e infraestrutura. Essa experiência aprimorou meu pensamento analítico, atenção a detalhes e capacidade de raciocínio em cenários complexos — habilidades que agora aplico à engenharia de software.",
        "journey.transition.date": "2024 — 2025 · A Virada",
        "journey.transition.title": "Desconstruindo a Lógica",
        "journey.transition.description":
            "Transição em tempo integral para o desenvolvimento de software. Foquei em Java, POO e desenvolvimento web moderno, construindo projetos full-stack e fortalecendo meus fundamentos em cloud. Trabalhei na NTT Data, uma das maiores consultoras de TI do mundo.",
        ...
        "skills.subtitle":
            "Um stack selecionado para performance e escalabilidade.",
        "skills.backend": "Backend",
        "skills.backend.1": "Java / POO / Spring Boot",
        "skills.backend.2": "Node.js / API (fundamentos)",
        "skills.backend.3": "SQL (MySQL / SQL Server)",
        "skills.backend.4": "Integração (MuleSoft)",
        "skills.backend.5": "Swift / Kotlin (básico mobile)",
        "skills.frontend": "Frontend",
        "skills.frontend.1": "HTML / CSS / UI Responsiva",
        "skills.frontend.2": "JavaScript / TypeScript",
        "skills.frontend.3": "React / Next.js",
        "skills.frontend.4": "Tailwind CSS",
        "skills.infra": "Infraestrutura",
        "skills.infra.1": "Azure Fundamentals",
        "skills.infra.2": "Deploys na Vercel",
        "skills.infra.3": "Google Cloud",
        "skills.infra.4": "BD Serverless (Neon)",
        "skills.tools": "Ferramentas",
        "skills.tools.1": "Git / GitHub",
        "skills.tools.2": "IntelliJ / VS Code",
        "skills.tools.3": "Postman / testes de API",
        "skills.tools.4": "Ágil (Azure DevOps / Jira)",
        ...
        "contact.description":
            "Se você busca construir uma aplicação web moderna ou precisa de um parceiro técnico com forte base analítica, entre em contato.",
        "contact.email.label": "Email",
        "contact.location.label": "Órbita Atual",
        "contact.location.value": "Portugal",
        "contact.form.name.label": "Identificação do Remetente",
        "contact.form.name.placeholder": "Seu nome",
        "contact.form.email.label": "Endereço de Retorno",
        "contact.form.email.placeholder": "email@exemplo.com",
        "contact.form.message.label": "Conteúdo da Mensagem",
        "contact.form.message.placeholder":
            "Descreva brevemente seu projeto...",
        "contact.form.submit": "Executar Transmissão",
        "contact.form.disclaimer":
    ...
    es: {
        ...
        "hero.description":
            "Profesional de TI luso-brasileño radicado en Portugal, en transición al desarrollo de software tras casi una década como abogado en el área regulatoria de petróleo & gas. Construyo aplicaciones web full-stack, cloud-ready, con fuerte enfoque en Java y desarrollo web moderno.",
        ...
        "journey.law.description":
            "Ejercí como abogado liderando trabajos regulatorios en petróleo & gas y infraestructura. Esa experiencia agudizó mi pensamiento analítico, atención al detalle y capacidad de razonamiento en escenarios complejos — habilidades que ahora aplico a la ingeniería de software.",
        "journey.transition.date": "2024 — 2025 · El Giro",
        "journey.transition.title": "Deconstruyendo la Lógica",
        "journey.transition.description":
            "Transición a tiempo completo al desarrollo de software. Me enfoqué en Java, POO y desarrollo web moderno, construyendo proyectos full-stack y fortaleciendo mis fundamentos en cloud. Trabajé en NTT Data, una de las mayores consultoras de TI del mundo.",
        ...
        "skills.subtitle":
            "Un stack seleccionado para rendimiento y escalabilidad.",
        "skills.backend": "Backend",
        "skills.backend.1": "Java / POO / Spring Boot",
        "skills.backend.2": "Node.js / API (fundamentos)",
        "skills.backend.3": "SQL (MySQL / SQL Server)",
        "skills.backend.4": "Integración (MuleSoft)",
        "skills.backend.5": "Swift / Kotlin (básico mobile)",
        "skills.frontend": "Frontend",
        "skills.frontend.1": "HTML / CSS / UI Responsiva",
        "skills.frontend.2": "JavaScript / TypeScript",
        ...
        "skills.infra.1": "Azure Fundamentals",
        "skills.infra.2": "Despliegues en Vercel",
        "skills.infra.3": "Google Cloud",
        "skills.infra.4": "BD Serverless (Neon)",
        "skills.tools": "Herramientas",
        "skills.tools.1": "Git / GitHub",
        "skills.tools.2": "IntelliJ / VS Code",
        "skills.tools.3": "Postman / testing de API",
        "skills.tools.4": "Ágil (Azure DevOps / Jira)",
        ...
        "contact.description":
            "Ya sea que busques construir una aplicación web moderna o necesites un socio técnico con sólida base analítica, no dudes en contactarme.",
        "contact.email.label": "Email",
        "contact.location.label": "Órbita Actual",
        "contact.location.value": "Portugal",
        "contact.form.name.label": "Identidad del Remitente",
        "contact.form.name.placeholder": "Tu nombre",
        "contact.form.email.label": "Dirección de Retorno",
        "contact.form.email.placeholder": "email@ejemplo.com",
        "contact.form.message.label": "Contenido del Mensaje",
        "contact.form.message.placeholder":
            "Describe brevemente tu proyecto...",
        "contact.form.submit": "Ejecutar Transmisión",
        "contact.form.disclaimer":
...
function applyLanguage(lang) {
    ...
    // innerHTML for elements with mixed content (span inside)
    ...
    // Update <html lang>
    var langMap = { en: "en", pt: "pt-BR", es: "es" };
